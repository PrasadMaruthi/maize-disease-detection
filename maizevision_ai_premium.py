    ...
    <div class="hero">
        <div class="hero-grid">
            <div>
                ...
                <h1>See the symptom.<br><span style="color:#a9f0c3">Understand the disease.</span></h1>
                <p>MaizeVision AI brings deep-learning image classification into a focused agricultural research interface for rapid preliminary recognition of important maize disease classes.</p>
                <div class="hero-pills">
                    <span class="hero-pill">🌽 6 classes</span>
                    <span class="hero-pill">🧠 Deep learning</span>
                    <span class="hero-pill">📊 Probability analysis</span>
                    <span class="hero-pill">🏫 UAS Bangalore</span>
                </div>
                <div class="hero-stats">
                    <div class="hero-stat"><strong>14,434+</strong><span>CURRENT IMAGE COLLECTION</span></div>
                    <div class="hero-stat"><strong>224 × 224</strong><span>MODEL INPUT</span></div>
                </div>
            </div>
            <div>
                <div class="ai-orb"><div class="ai-core">🌽</div><div class="ai-label">VISION • CLASSIFY • INTERPRET</div></div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
