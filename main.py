...
# Prefer the selected best-model filename used for the maize project.
# Keep best_model.keras as a fallback for compatibility.
MODEL_CANDIDATES = [
    BASE_DIR / "best_model_selected.keras",
...
def load_model():
    ...
    # Find the model beside this main.py file, rather than relying on
    ...
    if model_path is None:
        ...
        raise FileNotFoundError(
            "The trained maize model was not found beside main.py. "
            f"Expected one of: {[p.name for p in MODEL_CANDIDATES]}. "
